...
const GOAL_MAIN_CATEGORIES = [
  ...
  { id: 'business',  label: 'Business',
    icon: '<rect x="2.5" y="7" width="15" height="9.5" rx="1.8"/><path d="M7 7V5.3a1.8 1.8 0 011.8-1.8h2.4A1.8 1.8 0 0113 5.3V7"/><path d="M2.5 11h15"/>' },
  { id: 'debt',      label: 'Debt',
    icon: '<path d="M4 6l4.5 5 3-3L17 15"/><path d="M12.5 15H17v-4.5"/>' },
